...
#'   \item \strong{NTD\_Alt} \eqn{= \frac{Y(a,F,d)}{Y(a,M,d)} - \frac{\mathrm{APO}(F)}{\mathrm{APO}(M)}}
#'   \item \strong{TD\_Null} and \strong{NTD\_Null} variants are defined analogously
