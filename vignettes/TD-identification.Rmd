...
NTD is the most permissive of the three. See the `NTD-identification` vignette for a detailed walkthrough of NTD and the multiplicative bias that arises from normalization.
