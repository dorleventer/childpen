...
- **gender_ineq** ($\Delta\rho_{\text{Agg}}$): weighted average of `NTD_New` theta estimates — the aggregate gender-inequality penalty. Formally, $\Delta\rho_{\text{Agg}}(e) = \sum_d w_d \cdot \Delta\rho(d,d+e)$.
